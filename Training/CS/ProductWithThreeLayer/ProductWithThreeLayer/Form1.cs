...
namespace ProductManager
{
    public partial class Form1 : Form
    {
        ...
        {
            string connectString = "Data Source=.;Initial Catalog=bbsDB;Integrated Security=true";
        ...
        private void SearchButton_Click(object sender, EventArgs e)
        {
            ...
            int id = 1;
            _ProductVO = _productBUS.getProductById(id);
            if (_ProductVO.Product == null)
                MessageBox.Show("No Match Found!", "Not Found", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            else
                MessageBox.Show(_ProductVO.Product, "Result", MessageBoxButtons.OK, MessageBoxIcon.Information);
